...
-- lun 21 may 2018 10:06:11 VET
-- Model: elalmacenweb    Version: 1.0
...
-- -----------------------------------------------------
-- Schema elalmacenwebdb
-- -----------------------------------------------------
-- base de datois para projecto almacen fugaz
...
ENGINE = InnoDB
COMMENT = 'directorio en controller y que controllers puede ejecutar el' /* comment truncated */ /* usuario, los controlers y metodos son separados por coma*/;
...
ENGINE = InnoDB
COMMENT = 'que usuario puede usar que modulo o subdirectorio de control' /* comment truncated */ /*adores y acceder funciones*/;
...
ENGINE = InnoDB
COMMENT = 'productos que estan en el almacen, es como uan copia del pro' /* comment truncated */ /*ducto de catalogo*/;
...
CREATE TABLE IF NOT EXISTS `elalmacenwebdb`.`esk_almacen_producto` (
  ...
  `cod_ubicacionproducto` VARCHAR(40) NULL COMMENT 'llave surrogada, debe ser codubicacion + codproducto',
  ...
  PRIMARY KEY (`cod_ubicacionproducto`))
ENGINE = InnoDB
...
COMMENT = 'despacho maestro: definicion de documento para transito y re' /* comment truncated */ /*cibirlos*/;
...
COMMENT = 'pedido detalle : productos contenidos en el pedido especific' /* comment truncated */ /*o*/;
...
-- -----------------------------------------------------
-- Table `elalmacenwebdb`.`esk_almacen_existencia`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `elalmacenwebdb`.`esk_almacen_existencia` ;

CREATE TABLE IF NOT EXISTS `elalmacenwebdb`.`esk_almacen_existencia` (
  `cod_ubicacionproducto` VARCHAR(40) NULL COMMENT 'debe ser codubicacion + codproducto',
  `can_producto` DECIMAL(40,2) NOT NULL DEFAULT 0 COMMENT 'cantidad en dicha posicion del almacen',
  `cod_unidad` VARCHAR(40) NULL DEFAULT NULL COMMENT 'unidad de medida de cantidad del producto',
  `sessionflag` VARCHAR(40) NULL DEFAULT NULL COMMENT 'YYYYMMDDhhmmss.entidad.username quien altero',
  `sessionficha` VARCHAR(40) NULL DEFAULT NULL COMMENT 'YYYYMMDDhhmmss.entidad.username quien lo creo',
  PRIMARY KEY (`cod_ubicacionproducto`))
ENGINE = InnoDB
COMMENT = 'existencia y unidades ubicadas del producto en una sola tabl' /* comment truncated */ /*a*/;


-- -----------------------------------------------------
-- Table `elalmacenwebdb`.`esk_unidad_producto`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `elalmacenwebdb`.`esk_unidad_producto` ;

CREATE TABLE IF NOT EXISTS `elalmacenwebdb`.`esk_unidad_producto` (
  `cod_unidad` VARCHAR(40) NOT NULL COMMENT 'YYYYMMDDhhmmss',
  `des_unidad` VARCHAR(40) NULL DEFAULT 'Unidades' COMMENT 'nombre humano de este tipo de unidad de medicion',
  PRIMARY KEY (`cod_unidad`))
ENGINE = InnoDB
COMMENT = 'tabla de tipos de unidades de productos';


-- -----------------------------------------------------
-- Table `elalmacenwebdb`.`esk_proceso_aprobado`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `elalmacenwebdb`.`esk_proceso_aprobado` ;

CREATE TABLE IF NOT EXISTS `elalmacenwebdb`.`esk_proceso_aprobado` (
  `cod_proceso` VARCHAR(40) NOT NULL COMMENT 'codigo aprobar con dichas firmas',
  `cod_aprobado1` VARCHAR(40) NOT NULL COMMENT 'codigo generado al aprobar con firma 1',
  `cod_aprobado2` VARCHAR(40) NULL COMMENT 'codigo generado al aprobar con firma 2',
  `hex_aprobado_firma1` TEXT NULL COMMENT 'base64 de la firma aprobadora 1',
  `hex_aprobado_firma2` TEXT NULL COMMENT 'base64 de la firma aprobadora 1',
  `nam_tabla_proceso` VARCHAR(40) NULL COMMENT 'esk_pedido|esk_orden|esk_despacho|esk_almacen en donde busca el codigo aprobar',
  `sessionflag` VARCHAR(40) NULL COMMENT 'YYYYMMDDhhmmss.entidad.username de este registro',
  `sessionficha` VARCHAR(40) NULL COMMENT 'YYYYMMDDhhmmss.entidad.username de creacion deste registro',
  PRIMARY KEY (`cod_proceso`, `cod_aprobado1`))
ENGINE = InnoDB
COMMENT = 'firmas aprobatoria de cada proceso';
...
START TRANSACTION;
USE `elalmacenwebdb`;
INSERT INTO `elalmacenwebdb`.`esk_almacen_producto` (`cod_ubicacion`, `cod_producto`, `cod_ubicacionproducto`, `sessionflag`, `sessionficha`) VALUES ('20180101000002', '20180101000000', '2018010100000220180101000000', NULL, NULL);
INSERT INTO `elalmacenwebdb`.`esk_almacen_producto` (`cod_ubicacion`, `cod_producto`, `cod_ubicacionproducto`, `sessionflag`, `sessionficha`) VALUES ('20180401210000', '20180101000000', '2018040121000020180101000000', NULL, NULL);
...
INSERT INTO `elalmacenwebdb`.`esk_almacen_mapa` (`cod_entidad`, `cod_almacen`, `map_almacen`, `des_almacen`, `sessionflag`, `sessionficha`) VALUES ('20180101000102', '101', NULL, 'Narnia 1', NULL, NULL);
INSERT INTO `elalmacenwebdb`.`esk_almacen_mapa` (`cod_entidad`, `cod_almacen`, `map_almacen`, `des_almacen`, `sessionflag`, `sessionficha`) VALUES ('20180101000103', '102', NULL, 'Narnia 2', NULL, NULL);

COMMIT;


-- -----------------------------------------------------
-- Data for table `elalmacenwebdb`.`esk_almacen_existencia`
-- -----------------------------------------------------
START TRANSACTION;
USE `elalmacenwebdb`;
INSERT INTO `elalmacenwebdb`.`esk_almacen_existencia` (`cod_ubicacionproducto`, `can_producto`, `cod_unidad`, `sessionflag`, `sessionficha`) VALUES ('2018040121000020180101000000', 3, '20180101000000', NULL, NULL);
INSERT INTO `elalmacenwebdb`.`esk_almacen_existencia` (`cod_ubicacionproducto`, `can_producto`, `cod_unidad`, `sessionflag`, `sessionficha`) VALUES ('2018010100000220180101000000', 4, '20180101000000', NULL, NULL);

COMMIT;


-- -----------------------------------------------------
-- Data for table `elalmacenwebdb`.`esk_unidad_producto`
-- -----------------------------------------------------
START TRANSACTION;
USE `elalmacenwebdb`;
INSERT INTO `elalmacenwebdb`.`esk_unidad_producto` (`cod_unidad`, `des_unidad`) VALUES ('20180101000000', 'Unidades');
